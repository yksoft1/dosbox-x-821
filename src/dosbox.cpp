...
void DOSBOX_SetupConfigSections(void) {
	...
	const char* sbtypes[] = { "sb1", "sb2", "sbpro1", "sbpro2", "sb16", "gb", "ess688", "reveal_sc400", "none", 0 };
	...
	Pint = secprop->Add_int("initial frequency",Property::Changeable::WhenIdle,-1/*from original source code: ~903Hz*/);
